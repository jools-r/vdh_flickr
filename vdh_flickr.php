...
if (class_exists('\Textpattern\Tag\Registry')) {
    Txp::get('\Textpattern\Tag\Registry')
        ->register('vdh_flickr_set_img')
        ->register('vdh_flickr_set_title')
        ->register('vdh_flickr_set_description')
        ->register('vdh_flickr_set_number_of_photos')
        ->register('vdh_flickr_set_link')
        ->register('vdh_flickr_set_list')
        ->register('vdh_flickr_tag_list_all')
        ->register('vdh_flickr_tag_list_popular')
        ->register('vdh_flickr_tag_list_related')
        ->register('vdh_flickr_thumbnails')
        ->register('vdh_flickr_thumbnails_title')
        ->register('vdh_flickr_thumbnails_description')
        ->register('vdh_flickr_thumbnails_if_description')
        ->register('vdh_flickr_thumbnails_slideshow')
        ->register('vdh_flickr_thumbnails_img')
        ->register('vdh_flickr_thumbnails_img_title')
        ->register('vdh_flickr_thumbnails_link')
        ->register('vdh_flickr_thumbnails_list')
        ->register('vdh_flickr_thumbnails_number_of_photos')
        ->register('vdh_flickr_thumbnails_per_page')
        ->register('vdh_flickr_thumbnails_current_page')
        ->register('vdh_flickr_thumbnails_total_pages')
        ->register('vdh_flickr_thumbnails_pages_first')
        ->register('vdh_flickr_thumbnails_pages_last')
        ->register('vdh_flickr_thumbnails_pages_previous')
        ->register('vdh_flickr_thumbnails_pages_next')
        ->register('vdh_flickr_thumbnails_pages_list')
        ->register('vdh_flickr_thumbnails_pages_startthumb')
        ->register('vdh_flickr_thumbnails_pages_endthumb')
        ->register('vdh_flickr_thumbnails_if_multiple_pages')
        ->register('vdh_flickr_img')
        ->register('vdh_flickr_img_title')
        ->register('vdh_flickr_img_description')
        ->register('vdh_flickr_img_if_description')
        ->register('vdh_flickr_img_naked')
        ->register('vdh_flickr_img_link')
        ->register('vdh_flickr_img_previous')
        ->register('vdh_flickr_img_previous_thumbnail')
        ->register('vdh_flickr_img_next')
        ->register('vdh_flickr_img_next_thumbnail')
        ->register('vdh_flickr_img_set_title')
        ->register('vdh_flickr_img_set_link')
        ->register('vdh_flickr_img_tags')
        ->register('vdh_flickr_img_number_of_comments')
        ->register('vdh_flickr_img_comments_invite')
        ->register('vdh_flickr_img_date_posted')
        ->register('vdh_flickr_img_date_taken')
        ->register('vdh_flickr_env')
        ->register('vdh_flickr_if_preview')
        ->register('vdh_flickr_if_thumbnails')
        ->register('vdh_flickr_if_set')
        ->register('vdh_flickr_if_tags')
        ->register('vdh_flickr_if_img')
        ->register('vdh_flickr_show_nsid')
        ;
}
...
class Vdh_Flickr
{
    ...
    function __construct($params)
    {
        ...
        if ($GLOBALS['is_article_list'] === false) {
            $this->use_articleurl = true;
        }
        if (isset($params['use_articleurl']) and $params['use_articleurl'] == 1) {
            $this->use_articleurl = true;
        }
        if (isset($params['use_articleurl']) and $params['use_articleurl'] == 0) {
            $this->use_articleurl = false;
        }
        if (!isset($this->nsid)) {
            $this->getNsid();
        }
    ...
    public function getPhotoUrl($photo, $size)
    {
        ...
        $img_url = "https://farm${farm}.static.flickr.com/${server}/${id}_${secret}${imgsize}.${format}";
        return $img_url;
    }
...
class Gallery extends Vdh_Flickr
{
    ...
    public $i;
    public $set;
    public $set_preview_size;
    public $mode;
    public $sets_per_page;
    public $page;
    ...
    function __construct($params)
    {
        ...
        if (isset($params['except'])) {
            $this->exceptions = explode(",", $params['except']);
        }
        ...
        if (isset($params['set_form'])) {
            ...
            $this->form = fetch_form($params['set_form']);
        } else {
            $this->form = '
    ...
    public function add_to_sets($set_id, $i)
    {
        $set = array('id' => $set_id);
    ...
    public function set_number_of_photos()
    {
    ...
    public function set_list($params)
    {
        ...
        (isset($params['wraptag']) == true) ?
            $wraptag = $params['wraptag'] :
            $wraptag = '';
        (isset($params['break']) == true) ?
            $break = $params['break'] :
            $break = 'br';
        $this->i = 0;
        foreach ($this->sets as $this->set) {
            ($_GET['set'] == (float) $this->set['id']) ?
                $param = ' class="current"' :
                '';
            ($break != 'br') ?
...
class Thumbnails extends Vdh_Flickr
{
    ...
    public $tag_and;
    public $link;
    public $use_art_id_as_tag;
    public $page;
    public $thumbs_per_page;
    public $start;
    public $end;
    public $lastpage;
    public $previous_page;
    ...
    function __construct($params)
    {
        ...
        if (isset($params['tag_and'])) {
            $this->tag_and = 1;
        }
        if (isset($params['thumbnails_form'])) {
            $this->form = fetch_form($params['thumbnails_form']);
        } else {
            $this->form = '
    ...
    public function getPhotos()
    {
        ...
        if (isset($this->tags)) {
            ...
            if ($this->xml->isValid()) {
                ...
                if (isset($this->params['random'])) {
                    $this->randomize($this->params['random']);
                }
            }
        }
        if (isset($this->latest)) {
            ...
            if ($this->thumbs_per_page == 0 or $this->latest <= $this->thumbs_per_page) {
                $method .= '&per_page=' . $this->latest;
            } else {
    ...
    public function randomize($randsize)
    {
    ...
    public function thumbnails_title()
    {
    ...
    public function thumbnails_description()
    {
        if ((isset($this->description) == false) and isset($this->set)) {
            $this->getInfo();
        }
        if ($this->description != '&nbsp;' and !empty($this->description)) {
            return $this->description;
        }
        return '';
    }

    public function thumbnails_if_description($thing)
    {
        if ((isset($this->description) == false) and isset($this->set)) {
            $this->getInfo();
        }
    ...
    public function thumbnails_slideshow($thing)
    {
        if (isset($this->tags)) {
            $html = '<a href="https://www.flickr.com/slideShow/index.gne?nsid='.urlencode($this->nsid).'&amp;user_id='.urlencode($this->nsid);
            if (isset($this->tag_and)) {
        ...
        if (isset($this->set)) {
            $html = '<a href="https://www.flickr.com/slideShow/index.gne?nsid='.urlencode($this->nsid).'&amp;set_id='.$this->set;
            $html .= '"  onclick="window.open(this.href, \'slideShowWin\', \'width=800,height=600,top=150,left=70,scrollbars=no, status=no, resizable=no\'); ';
            $html .= 'return false;">';
        }
        if (isset($this->latest)) {
            $html = '<a href="https://www.flickr.com/slideShow/index.gne?nsid='.urlencode($this->nsid).'&amp;user_id='.urlencode($this->nsid).'&amp;maxThumbs='.$this->latest;
            $html .= '"  onclick="window.open(this.href, \'slideShowWin\', \'width=800,height=600,top=150,left=70,scrollbars=no, status=no, resizable=no\'); ';
            $html .= 'return false;">';
        }
        $html .= $thing.'</a>';
    ...
    public function thumbnails_img()
    {
        $img_url = $this->getPhotoUrl($this->photo, $this->thumbnail_size);
        $img_url = '<img src="' . $img_url . '" class="c-flickrgallery__img" alt="' . $this->photo['title'] . '" />';
        return $img_url;
    }

    public function thumbnails_img_title()
    {
        return $this->photo['title'];
    }

    public function thumbnails_link($img_url, $title ="")
    {
        if ($this->open == 'self') {
            if (isset($this->set)) {
        ...
        if ($this->open == 'flickr') {
            $html = '<a href="https://www.flickr.com/photos/' . urlencode($this->nsid) . '/' . $this->photo['id'] . '/">' . "\n";
            $html .= $img_url;
            $html .= '</a>' . "\n";
        }
        if ($this->open == 'window') {
        ...
        if ($this->open == 'lightbox') {
            ...
            $set = trim($set);
            $html = '<li class="c-flickrgallery__item"><a data-fancybox="'.$set.'" href="';
//          $html = '<li class="c-flickrgallery__item"><a class="fancybox" href="';
            $html .= $this->getPhotoUrl($this->photo, $this->img_size);
//          $html .= '" rel="lightbox['.$set.']"';
//          $html .= ' title="'.$title.'">';
            $html .= '" data-caption="'.trim($title).'">';
            $html .= $img_url;
            $html .= '</a></li>';
        }
        return $html;
    ...
    public function thumbnails_list($params)
    {
        if (!$this->xml->isValid()) {
            return false;
        }
        ...
        for ($this->i = $this->start - 1; $this->i <= $this->end - 1; $this->i++) {
            ...
            (@$_GET['img'] == (float) $this->photo['id']) ?
                $param = ' class="current"' :
                '';
            ($this->listmode == 'img') ?
                $what = $this->thumbnails_img() :
                $what = $this->thumbnails_img_title();
            ($this->linkthumbs == 1) ?
                $what = $this->thumbnails_link($what, $this->photo["title"]) :
                '';
            if ($break != '') {
                ($break != 'br') ?
    ...
    public function thumbnails_number_of_photos()
    {
        return $this->number_of_photos;
    }

    public function thumbnails_per_page()
    {
        return $this->thumbs_per_page;
    }

    public function thumbnails_current_page()
    {
        return $this->page;
    }

    public function thumbnails_total_pages()
    {
        return $this->lastpage;
    }

    public function thumbnails_pages_first($thing)
    {
        if (isset($this->set)) {
            $result = tag(parse($thing), 'a', ' href="'. $this->makeRequest(array('set' => $this->id, 'page' => 1)) .'"');
        }
        if (isset($this->tags)) {
            $result = tag(parse($thing), 'a', ' href="'. $this->makeRequest(array('tags' => $this->tags, 'page' => 1)) .'"');
        }
        if (isset($this->latest)) {
            $result = tag(parse($thing), 'a', ' href="'. $this->makeRequest(array('page' => 1)) .'"');
        }
        return $result;
    }

    public function thumbnails_pages_last($thing)
    {
        if (isset($this->set)) {
            $result = tag(parse($thing), 'a', ' href="'. $this->makeRequest(array('set' => $this->id, 'page' => $this->lastpage)) .'"');
        }
        if (isset($this->tags)) {
            $result = tag(parse($thing), 'a', ' href="'. $this->makeRequest(array('tags' => $this->tags, 'page' => $this->lastpage)) .'"');
        }
        if (isset($this->latest)) {
            $result = tag(parse($thing), 'a', ' href="'. $this->makeRequest(array('page' => $this->lastpage)) .'"');
        }
        return $result;
    }

    public function thumbnails_pages_previous($thing)
    {
        if (isset($this->set)) {
            $result = tag(parse($thing), 'a', ' href="'. $this->makeRequest(array('set' => $this->id, 'page' => $this->previous_page)) .'"');
        }
        if (isset($this->tags)) {
            $result = tag(parse($thing), 'a', ' href="'. $this->makeRequest(array('tags' => $this->tags, 'page' => $this->previous_page)) .'"');
        }
        if (isset($this->latest)) {
            $result = tag(parse($thing), 'a', ' href="'. $this->makeRequest(array('page' => $this->previous_page)) .'"');
        }
        return $result;
    }

    public function thumbnails_pages_next($thing)
    {
        if (isset($this->set)) {
            $result = tag(parse($thing), 'a', ' href="'. $this->makeRequest(array('set' => $this->id, 'page' => $this->next_page)) .'"');
        }
        if (isset($this->tags)) {
            $result = tag(parse($thing), 'a', ' href="'. $this->makeRequest(array('tags' => $this->tags, 'page' => $this->next_page)) .'"');
        }
        if (isset($this->latest)) {
            $result = tag(parse($thing), 'a', ' href="'. $this->makeRequest(array('page' => $this->next_page)) .'"');
        }
        return $result;
    }

    public function thumbnails_pages_startthumb()
    {
        return $this->start;
    }

    public function thumbnails_pages_endthumb()
    {
        return $this->end;
    }

    public function thumbnails_pages_list($params)
    {
        $pages_array = range(1, $this->lastpage);
        for ($i = 0; $i <= $this->lastpage - 1; $i++) {
            if (isset($this->set)) {
                $pages_array[$i] = tag($pages_array[$i], 'a', ' href="'. $this->makeRequest(array('set' => $this->id, 'page' => $pages_array[$i])) .'"');
            }
            if (isset($this->tags)) {
                $pages_array[$i] = tag($pages_array[$i], 'a', ' href="'. $this->makeRequest(array('tags' => $this->tags, 'page' => $pages_array[$i])) .'"');
            }
            if (isset($this->latest)) {
                $pages_array[$i] = tag($pages_array[$i], 'a', ' href="'. $this->makeRequest(array('page' => $pages_array[$i])) .'"');
            }
        }
        return doWrap($pages_array, @$params['wraptag'], @$params['break'], @$params['class'], @$params['breakclass'], @$params['atts']);
    }

    public function thumbnails_if_multiple_pages($thing)
    {
        ($this->thumbs_per_page != 0) ?
            $result = parse($thing) :
            '';
...
class Picture extends Vdh_Flickr
{
    ...
    public function img_link($img_url)
    {
        if (isset($this->link)) {
            switch ($this->link) {
                case "flickr":
                    $link_target = 'https://www.flickr.com/photos/' . urlencode($this->nsid) . '/' . $this->id . '/';
                break;
                ...
                case "img_information":
                    $link_target = 'https://www.flickr.com/photo_exif.gne?id=' . $this->id;
                break;
            }
    ...
    public function img_previous($label, $thing)
    {
        ...
        if ($this->previous['id'] != 0) {
            ...
            if (isset($this->set)) {
                $html = tag($thing, 'a', ' href="'. $this->makeRequest(array('set' => $this->set, 'img' => $this->previous['id'])) .$end.'"')."\n";
            } else {
                $html = tag($thing, 'a', ' href="'. $this->makeRequest(array('img' => $this->previous['id'])) .$end.'"')."\n";
            }
        }
        return $html;
    }

    public function img_previous_thumbnail()
    {
        if (!isset($this->context)) {
            $this->getContext();
        }
    ...
    public function img_next($label, $thing)
    {
        if (!isset($this->context)) {
            $this->getContext();
        }
        ...
        if ($this->next['id'] != 0) {
            ...
            $end = '" title="'. $label . $title;
            if (isset($this->set)) {
                $html = tag($thing, 'a', ' href="'. $this->makeRequest(array('set' => $this->set, 'img' => $this->next['id'])) .$end.'"')."\n";
            } else {
                $html = tag($thing, 'a', ' href="'. $this->makeRequest(array('img' => $this->next['id'])) .$end.'"')."\n";
            }
        }
        return $html;
    }

    public function img_next_thumbnail()
    {
        if (!isset($this->context)) {
            $this->getContext();
        }
    ...
    public function img_set_link($thing)
    {
        if (isset($this->set)) {
    ...
    public function img_description()
    {
        $description_string = (string) $this->description;
        if ($description_string != 'Array') {
            return $description_string;
        }
    }

    public function img_if_description($thing)
    {
        if ($this->description != '&nbsp;' and !empty($this->description)) {
            $result = parse($thing);
        } else {
    ...
    public function img_tags($separator)
    {
    ...
    public function img_number_of_comments()
    {
        return $this->comments;
    }

    public function img_comments_invite($invitetext)
    {
        return tag($invitetext, 'a', ' href="' . 'https://www.flickr.com/photos/' . urlencode($this->nsid) . '/' . $this->id . '/"');
    }

    public function img_date_posted($params)
    {
        if (isset($params['format'])) {
            return safe_strftime($params['format'], $this->date_posted);
        }
        global $archive_dateformat;
        return safe_strftime($archive_dateformat, $this->date_posted);
    }

    public function img_date_taken($params)
    {
        if (isset($params['format'])) {
            return safe_strftime($params['format'], strtotime($this->date_taken));
        }
        global $archive_dateformat;
...
class Taglist extends Vdh_Flickr
{
    ...
    public function list_popular($params)
    {
        isset($params['count']) ?
    ...
    public function list_related($params)
    {
        isset($params['source_tag']) ?
            $this->source_tag = $params['source_tag'] :
            $this->source_tag = '';
        $method = 'flickr.tags.getRelated' . $this->userdata . '&tag=' . $this->source_tag;
        return $this->generateList($method, $params);
    }

    public function generateList($method, $params)
    {
        $this->xml = new Flickr($method);
        if ($this->xml->isValid()) {
...
class Flickr
{
    public $xmlurl = 'https://api.flickr.com/services/rest/?method=';
    public $xml;
